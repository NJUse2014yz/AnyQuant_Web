...
//	}
//
//	public TestReport runTest_self(List<ChooseStock> stockList,double invest,Date startdate, Date enddate, int n,
//			List<AnalyseSignalPack> analyseSignalPacks,String benchmark,AnalyseSignalPack bAnalyseSignalPack) throws Exception {
//		setParam(stockList,invest,startdate,enddate,n,analyseSignalPacks,benchmark,bAnalyseSignalPack);
//		return test();
//	}
...
//			for(int j=0;j<stockList.size();j++)//对于股仓中的某支股票
//			{
