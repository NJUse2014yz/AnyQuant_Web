...
public class MultipleFunction extends Function {
	public double v1;
	public Function v1F;
	public double v2;
	public Function v2F;
	...
	public MultipleFunction(double v1,double v2)
	{
		this();
		this.function="Multiple";
		this.v1=v1;
	...
	public MultipleFunction(double v1, Function v1f, double v2, Function v2f) {
		this();
		this.function="Multiple";
		this.v1 = v1;
		this.v1F = v1f;
	...
	public MultipleFunction(MultipleVO vo)
	{
		this();
		this.function="Multiple";
	...
	public String toString() {
		return "\nMultipleFunction [v1=" + v1 + ", v1F=" + v1F + ", v2=" + v2 + ", v2F=" + v2F + ", function=" + function
